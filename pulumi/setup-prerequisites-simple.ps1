# Simple PowerShell script to install prerequisites for Pulumi Kind monorepo
...
Write-Host ""
Write-Host "IMPORTANT: Project deployment must be done MANUALLY!" -ForegroundColor Red
